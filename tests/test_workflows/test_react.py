...
from vlm_agent_gateway.config import CODE_AGENT_SYSTEM_PROMPT, REACT_SYSTEM_PROMPT
...
def test_run_react_uses_default_system_prompt(monkeypatch):
    ...
    monkeypatch.setattr("vlm_agent_gateway.workflows.react.run_agent", fake_run_agent)
